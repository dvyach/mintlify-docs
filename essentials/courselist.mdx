...
<Card title="MongoDB Data Modeling Intro" icon="square-1" href="api-reference\course.mdx">
  ...
  <Card title="Identifying Database Workloads" icon="square-2" href="api-reference\course.mdx">
