...
description: The agent workspace contains all the tools that a support agent would need to manage the connected devices. Agent workspace has the following options
-Notifications
-Compliance
-Manage devices
